...
//IMPLEMENTACAO EXPERIMENTAL DE VELOCIDADE PELO PULSEIN

double veloc_ON;         //Variável que armazena a leitura INSTANTÂNEA do tempo de injeção.
double veloc_OFF;
int    veloc_PULSE; 

//EXCLUIR O CODIGO ACIMA CASO NAO SEJA UTILIZADO
...
void serial0() {
  ...
  Serial.print(" || ");
   Serial.print("Veloc+PULSE = ");
  Serial.print(veloc_PULSE, DEC);
  Serial.print(" || ");
...
//================================== ROTAÇÃO =======================================
  ...
  veloc_ON = pulseIn(1, HIGH);
  veloc_OFF = pulseIn(1, LOW);
  
  veloc_PULSE = ((1/((veloc_ON + veloc_OFF)/2000))*750);
    //veloc = ((1/((veloc_ON)/2000))*860) / 2;
