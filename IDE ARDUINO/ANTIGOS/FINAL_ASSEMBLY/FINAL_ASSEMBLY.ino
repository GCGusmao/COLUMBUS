...
EnergyMonitor SCT013;
 ...
 //CRIA UMA INSTÂNCIA para ZMPT101b
EnergyMonitor emon1;
...
void setup() {
  ...
  balanca.begin(DOUT, CLK, 128);                          // inicializa a balança
  ...
  balanca.tare();    
    ...
    Serial.println("Escolha a opção de visualização dos dados. Digite '1' para modo leitura, '2' para modo aquisição."); // Imprime na tela
    Serial.println("Caso nenhum modo seja escolhido, o modo de leitura será escolhido automaticamente."); // Imprime na tela
