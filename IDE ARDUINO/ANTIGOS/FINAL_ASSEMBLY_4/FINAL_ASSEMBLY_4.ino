...
void serial1() {
  ...
  Serial1.print(b1tensao * 3.01, 2);
  Serial1.print ("V");
  Serial1.print(" || ");

  Serial1.print("Tensao B2: ");
  Serial1.print(b2tensao * 3.01, 2);
  Serial1.print ("V");
  Serial1.print(" || ");

  Serial1.print("Tensao B3: ");
  Serial1.print(b3tensao * 3.01, 2);
  Serial1.print ("V");
  Serial1.print(" || ");

  Serial1.print("Tensao B4: ");
  Serial1.print(b4tensao * 3.01, 2);
  Serial1.print ("V");
  Serial1.print(" || ");
...
void gravacaoTask() {
  //=================== SD CARD ===========================
  myFile = SD.open("datalog.txt", FILE_WRITE); // Cria / Abre arquivo .txt
...
//========================== ROTAÇÃO ============================
    ...
    myFile.print(","); // Escreve no Arquivo
//========================== CORRENTE LV =========================
    myFile.print("Corrente 48V"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(correnteLV); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
//========================== TENSÃO LV ===========================
    myFile.print("Tensão B1"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(b1tensao); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print("Tensão B2"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(b2tensao); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print("Tensão B3"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(b3tensao); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print("Tensão B4"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(b4tensao); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
//========================== CORRENTE HV =========================
    myFile.print("Corrente 220V"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(corrente250v); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
//========================== TENSÃO HV =========================
    myFile.print("Tensão 220V"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(tensao250v); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
//========================== TEMPERATURA BATERIAS =================
    myFile.print("Temperatura B1"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(b1temp); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print("Temperatura B2"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(b2temp); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print("Temperatura B3"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(b3temp); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print("Temperatura B4"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
    myFile.print(b4temp); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
//========================== MASSA COMBUSTIVEL =========================
    myFile.print("Massa combustível"); // Escreve no Arquivo
    myFile.print(","); // Escreve no Arquivo
...
//================================== CORRENTE 220V =================================
  ...
  corrente250v = SCT013.calcIrms(1480);   // Calcula o valor da Corrente
